...
Immigration officers must be satisfied that the information an applicant submits complies with the evidential requirements set out in residence instructions.
Even if an applicant meets the specific evidential requirements, an immigration officer may still decide that additional evidence is necessary.
Immigration officers should use their discretion to decide what is sufficient evidence for rules and criteria that have no specific evidential requirements.
